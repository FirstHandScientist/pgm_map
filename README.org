...
- Yoon et al, 2018, [[https://arxiv.org/abs/1803.07710][Inference in Probabilistic Graphical Models by Graph Neural Networks]], Training neural network to do message passing, NN for message updates, and also NN for mapping messages to estimations. Trained NNs can be used for different factor graphs with different potentials and structures.
